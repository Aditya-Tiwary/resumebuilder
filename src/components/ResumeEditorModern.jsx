  ...
  const [resumeData, setResumeData] = useState({
    ...
    experience: [
      ...
      },
      {
        ...
        date: '2011 - 2014',
        companyLocation: 'Cupertino, CA, USA',
        accomplishment:
          '• Assisted in project management tasks, including planning, execution, and status updates communication.\n' +
          '• Delivered timeline in IT projects leading to a 10% reduction in project delivery time.\n' +
    ...
    achievements: [
      ...
      {
        keyAchievements: 'Strong Leadership',
        describe:
          'Experienced in leading and mentoring teams, resulting in highly efficient project execution.',
      },
      {
        keyAchievements: 'Efficient Resource Allocation',
        describe:
          'Spearheaded the reorganization of resource allocation in projects, resulting in a 15% cost reduction.',
      },
    ],
    languages: [
    ...
    skills: [
      ...
      {
        category: 'Mentorship',
        items: ['Mentorship', 'Organizational Skills'],
      },
    ],
    projects: [],
  });
